<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="InventoryMgmt.Admin.AdminDashboard" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="background-color: azure; padding: 10px;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card" style="width: 18rem;">
                                                <div class="card-body">
                                                    ...
                                                    <%--<h6 class="card-subtitle mb-2 text-body-secondary">0</h6>  --%>
                                                    <a href="#" class="card-link">View All Role</a>
                                                    <a href="#" class="card-link">Add New Role</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card" style="width: 18rem;">
                                                <div class="card-body">
                                                    <h5 class="card-title">Role Mapping</h5>
                                                    <%--<h6 class="card-subtitle mb-2 text-body-secondary">0</h6>  --%>
                                                    <a href="#" class="card-link">View All Role</a>
                                                    <a href="#" class="card-link">Add New Role</a>
                                                </div>
