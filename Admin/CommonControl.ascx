<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommonControl.ascx.cs" Inherits="InventoryMgmt.Admin.CommonControl" %>
 <!--  App Topstrip -->
        <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
                ...
                <h3 style="color: white;">Inventory UC</h3>

            </div>

            <div class="d-lg-flex align-items-center gap-2">
                <%--<h3 id="" runat="server" class="text-white mb-2 mb-lg-0 fs-5 text-center"></h3>--%>
                <asp:Label ID="lblName" runat="server" class="text-white mb-2 mb-lg-0 fs-5 text-center"></asp:Label> 
                <div class="d-flex align-items-center justify-content-center gap-2">

                    <div class="dropdown d-flex">
                        <a class="btn btn-primary d-flex align-items-center gap-1 " href="../LoginPage.aspx" id="drop4"
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="AdminDashboard.aspx" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between"
                                href="UserDetails.aspx" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="hide-menu">User Role Mapping</span>
                                </div>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="hide-menu">Role Manmgement</span>
                                </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <span class="hide-menu">Product In</span>
                                        </div>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link justify-content-between"
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <span class="hide-menu">Product Out</span>
                                        </div>
