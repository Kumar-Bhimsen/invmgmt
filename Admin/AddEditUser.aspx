<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEditUser.aspx.cs" Inherits="InventoryMgmt.Admin.AddEditUser" %>
...
<body style="background-color:aliceblue;">
    <form id="form1" runat="server">
     ...
     <div class="container card card-body" style="background-color:white;" >
         
         <div class="row bottom alert alert-info" style="height:60px;">
             <div class="col-md-6">
                   <h3 style="color: darkblue; width: 200px;">Add/Edit User</h3>
        ...
        <asp:TextBox ID="txtConfirmPassword" CssClass="form-control" runat="server"></asp:TextBox>
         ...
         <div class="row">
             <div class="col-md-6">
                 ...
                 <a href="UserDetails.aspx" class="btn btn-primary">Back</a>
             </div>
             <div class="col-md-6">
             </div>
